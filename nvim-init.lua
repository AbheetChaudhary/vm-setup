...
vim.keymap.set('n', '<leader>bb', ':buffers<CR>:b')
vim.keymap.set('n', '<leader>bj', ':JABSOpen<CR>')
...
vim.opt.statusline = "%<%f%m [%{&ff}:%{&fenc}:%Y] %{getcwd()} %= Line:%l/%L Column:%c%V %P"
...
-- vim.opt.tags = "tags,/home/goliath/.config/nvim/system.tags"
